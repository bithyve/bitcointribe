...
var images = {
    ...
    onBoardingScreen: {
        ...
        onB2: require(assetsImages +
            'onBoardingScreen/illustration_security.png'),
        onB3: require(assetsImages + 'onBoardingScreen/illustration_share.png'),
        simpleSecureSmart: require(assetsImages +
            'onBoardingScreen/illustration.png')
    },
    RestoreRecoverScreen: {
        restore: require(assetsImages + 'RestoreAndRecoverScreen/restore.png')
    },
    RestoreWalletUsingMnemonic: {
        walletrestored: require(assetsImages +
            'walletRestoreUsingPassphrase/illustration_walletrestored.png')
    },
    RestoreWalletUsingTrustedContact: {
        contactPassbook: require(assetsImages +
            'RestoreWalletUsingTrustedContact/ContactsPassbook.png'),
        share4and5SelfShareInfo: require(assetsImages +
            'RestoreWalletUsingTrustedContact/restore4and5sharebgimage.jpg'),
        successImage: require(assetsImages +
            'RestoreWalletUsingTrustedContact/restoreWalletTrustedContactSuccess.png')
    },
    WalletSetupScreen: {
        WalletScreen: {
    ...
    loginScreen: {
        backgoundImage: require(assetsImages +
            'loginscreen/loginBackgound.jpg'),
    ...
    secureAccount: {
        secureLogo: require(assetsImages +
            'secureAccount/secureAccountLogo.png'),
    ...
    backupSecureAccount: {
        steps: require(assetsImages +
            'backupSecureAccount/backupsecureAccount.png'),
        failedBackup: require(assetsImages +
            'icon/illustration_unsucessful.png')
    },
    ...
    backupSecureTwoFactorAuto: {
        icon: require(assetsImages +
            'backupSecureTwoFactorAuto/icon_shieldyellow.png')
    },
    helperScreen: {
...
const svgIcon = {
    ...
    healthoftheapp: {
        //png
        trustedcontactsPNG: require(assetsSVG +
            'healthoftheapp/trustedcontacts.png'),
        selectcontactsPNG: require(assetsSVG +
            'healthoftheapp/selectcontacts.png'),
        ...
        secretquestionsPNG: require(assetsSVG +
            'healthoftheapp/secretquestions.png'),
        questionPNG: require(assetsSVG + 'healthoftheapp/question.png'),
        //svg
        trustedcontactsSVG: require(assetsSVG +
            'healthoftheapp/trustedcontacts.svg'),
        selectcontactsSVG: require(assetsSVG +
            'healthoftheapp/selectcontacts.svg'),
        ...
        secretquestionsSVG: require(assetsSVG +
            'healthoftheapp/secretquestions.svg'),
        questionSVG: require(assetsSVG + 'healthoftheapp/question.svg')
    },
    walletScreen: {
        //png
        dailyAccountPNG: require(assetsSVG + 'walletscreen/dailywallet.png'),
        secureAccountPNG: require(assetsSVG +
            'walletscreen/icon_securewallet.png'),
        ...
        secureAccountSVG: require(assetsSVG +
            'walletscreen/icon_securewallet.svg'),
    ...
    transactionScreen: {
        ...
        PNG5: require(assetsSVG +
            'transactionScreen/icon_shieldgreen_tick.png'),
        //svg
