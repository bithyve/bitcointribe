...
const images = {
  ...
  onBoardingScreen: {
    onB1: require(`${assetsImages}onBoardingScreen/illustration_multipleaccounts.png`),
  ...
  accountDetailsOnBoarding: {
    secureAccount: {
      img1: require(`${assetsImages}accountDetailsOnBoarding/secureAccount/sec01.jpg`),
      img2: require(`${assetsImages}accountDetailsOnBoarding/secureAccount/sec02.png`),
      img3: require(`${assetsImages}accountDetailsOnBoarding/secureAccount/sec03.png`),
    },
    jointAccount: {
      img1: require(`${assetsImages}accountDetailsOnBoarding/jointAccount/joint01.jpg`),
      img2: require(`${assetsImages}accountDetailsOnBoarding/secureAccount/sec02.png`),
      img3: require(`${assetsImages}accountDetailsOnBoarding/jointAccount/joint03.jpg`),
    },
    vaultAccount: {
      img1: require(`${assetsImages}accountDetailsOnBoarding/vaultAccount/vault001.png`),
      img2: require(`${assetsImages}accountDetailsOnBoarding/vaultAccount/vault02.png`),
    },
  },
  secureAccount: {
