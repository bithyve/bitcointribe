  ...
  componentDidMount() {
    ...
    db.transaction( function ( txn ) {
      ...
      txn.executeSql(
        ...
        " (id  INTEGER PRIMARY KEY AUTOINCREMENT,dateCreated TEXT,share TEXT NOT NULL DEFAULT '',shareId TEXT NOT NULL DEFAULT '',keeperInfo TEXT NOT NULL DEFAULT '',recordId TEXT NOT NULL DEFAULT '',mobileNo TEXT NOT NULL DEFAULT '',transferMethod TEXT NOT NULL DEFAULT '',sharedDate TEXT NOT NULL DEFAULT '',history TEXT NOT NULL DEFAULT '',acceptedDate TEXT NOT NULL DEFAULT '',decryptedShare TEXT NOT NULL DEFAULT '',lastSuccessfulCheck TEXT NOT NULL DEFAULT '',shareStage TEXT NOT NULL DEFAULT '')",
        []
      );
      txn.executeSql(
        "CREATE TABLE IF NOT EXISTS " +
