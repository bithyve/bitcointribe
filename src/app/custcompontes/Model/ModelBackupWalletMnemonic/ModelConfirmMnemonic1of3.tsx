...
export default class ModelConfirmMnemonic1of3 extends Component<Props, any> {
                    ...
                    <View style={ styles.viewModelBody }>
                        ...
                        <View style={ { flex: 1, alignItems: "center", justifyContent: "flex-start" } }>
                            <View style={ { flexDirection: "row", justifyContent: "flex-end", alignItems: "flex-end" } }>
                                <Text note style={ { fontSize: 32 } }> 1 </Text>
                                <Text note style={ { fontSize: 24 } }> of </Text>
                                <Text note style={ { fontSize: 32 } }> 3 </Text>
                            </View>
                            <Text note style={ [ globalStyle.ffFiraSansMedium, { textAlign: "center", marginTop: 20 } ] }>Enter the  <Text>{ number }</Text> number word from the mnemonic</Text>
                        </View>
                        <View
                            style={ {
                                flex: 1,
                        ...
                        >
                            ...
                            { renderIf( textBorderColor == "red" )(
                                <Text note style={ { color: "red", alignSelf: "flex-end" } }>Invalid word!</Text>
                            ) }
                        </View>
