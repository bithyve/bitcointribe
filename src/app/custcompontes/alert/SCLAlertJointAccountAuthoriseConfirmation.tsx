      ...
      <View style={styles.container}>
        <SCLAlert
          ...
          headerIconComponent={
            <Icon
              name={
                this.props.data.length != 0 ? this.props.data[0].icon : null
              }
              size={50}
              color="#fff"
            />
        ...
        >
          ...
          <SCLAlertButton
            theme="info"
            onPress={() => this.props.click_Ok(true)}
          >
            {this.props.data.length != 0
              ? this.props.data[0].confirmTitle
              : null}
          </SCLAlertButton>
          <SCLAlertButton
            theme="info"
            onPress={() => this.props.click_Ok(false)}
          >
            CANCEL
          </SCLAlertButton>
        </SCLAlert>
