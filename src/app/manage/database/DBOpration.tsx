                ...
                if (len > 0) {
                    for (let i = 0; i < len; i++) {
                        ...
                        if (tableName == 'tblWallet') {
                            data.id = data.id;
                            data.address = utils.decrypt(
                                data.address,
                                passcode
                            );
                            data.privateKey = utils.decrypt(
                                data.privateKey,
                                passcode
                            );
                            data.mnemonic = utils.decrypt(
                                data.mnemonic,
                                passcode
                            );
                            ...
                            data.publicKey = utils.decrypt(
                                data.publicKey,
                                passcode
                            );
                            data.walletType = utils.decrypt(
                                data.walletType,
                                passcode
                            );
                            data.backupInfo = utils.decrypt(
                                data.backupInfo,
                                passcode
                            );
                            ...
                            data.accountName = utils.decrypt(
                                data.accountName,
                                passcode
                            );
                            ...
                            data.shareId = utils.decrypt(
                                data.shareId,
                                passcode
                            );
                            data.keeperInfo = utils.decrypt(
                                data.keeperInfo,
                                passcode
                            );
                            data.sharedDate = utils.decrypt(
                                data.sharedDate,
                                passcode
                            );
                            data.history = utils.decrypt(
                                data.history,
                                passcode
                            );
                            ...
                            data.acceptedDate = utils.decrypt(
                                data.acceptedDate,
                                passcode
                            );
                            ...
                            data.shareStage = utils.decrypt(
                                data.shareStage,
                                passcode
                            );
                            data.recordId = utils.decrypt(
                                data.recordId,
                                passcode
                            );
                            ...
                            data.confimation = utils.decrypt(
                                data.confimation,
                                passcode
                            );
                            data.tranDate = utils.decrypt(
                                data.tranDate,
                                passcode
                            );
                            ...
                            data.senderAddress = utils.decrypt(
                                data.senderAddress,
                                passcode
                            );
                            ...
                            data.urlScript = utils.decrypt(
                                data.urlScript,
                                passcode
                            );
                            data.decrShare = utils.decrypt(
                                data.decrShare,
                                passcode
                            );
                            data.metaData = utils.decrypt(
                                data.metaData,
                                passcode
                            );
                            data.nonPMDDData = utils.decrypt(
                                data.nonPMDDData,
                                passcode
                            );
                            data.history = utils.decrypt(
        ...
        db.transaction(function(txn) {
            ...
            txn.executeSql(
                ...
                [
                    ...
                    utils.encrypt(
                        JSON.stringify(appHealthStatus).toString(),
                        passcode
                    ),
                    utils.encrypt(
                        JSON.stringify(backupInfo).toString(),
                        passcode
                    ),
                    utils.encrypt(fulldate.toString(), passcode)
                ]
                    ...
                    (tx, results) => {
                        ...
                        if (len > 0) {
                            for (let i = 0; i < len; i++) {
                                ...
                                let encpAccountType = results.rows.item(i)
                                    .accountType;
            ...
            db.transaction(function(txn: any) {
                txn.executeSql(
                    ...
                    [
                        ...
                        utils.encrypt(
                            JSON.stringify(addInfo).toString(),
                            passcode
                        ),
                        id
                    ]
            ...
            for (let i = 0; i < transactionDetails.length; i++) {
                ...
                txn.executeSql(
                    ...
                    [
                        ...
                        utils.encrypt(
                            transactionDetails[i].amount.toString(),
                            passcode
                        ),
                        utils.encrypt(
                        ...
                        utils.encrypt(
                            transactionDetails[i].date.toString(),
                            passcode
                        ),
                        utils.encrypt(
                            transactionDetails[i].fee.toString(),
                            passcode
                        ),
                        utils.encrypt(
                            transactionDetails[i].recipientAddresses !=
                                undefined
                                ? transactionDetails[
                                      i
                        ...
                        utils.encrypt(
                            (transactionDetails[i].senderAddresses != undefined
                                ? JSON.stringify(
                                      transactionDetails[i].senderAddresses
                                  )
                                : ''
                            ).toString(),
                            passcode
    ...
    return new Promise((resolve, reject) => {
        ...
        db.transaction(function(txn: any) {
            for (let i = 0; i < temp.type.length; i++) {
                ...
                let shareId =
                    temp.shareId != null
                        ? temp.shareId[i].data.shareId.toString()
                        : '';
                let keeperInfo =
                ...
                let metaShare =
                    temp.encryptedMetaShare[i].metaShare != null
                        ? JSON.stringify(
                              temp.encryptedMetaShare[i].metaShare
                          ).toString()
                        : '';
                txn.executeSql(
                    'INSERT INTO ' +
                    ...
                    [
                        ...
                        utils.encrypt(
                            JSON.stringify(histroy).toString(),
                            passcode
                        ),
                ...
                for (let ii = 0; ii < len; ii++) {
                    ...
                    if (dbdecryptType == type) {
                        txn.executeSql(
                            ...
                            [
                                utils.encrypt(
                                    JSON.stringify(shares).toString(),
                                    passcode
                                ),
                                utils.encrypt(
                                    JSON.stringify(temp).toString(),
                        ...
                        (tx, results) => {
                            ...
                            if (len > 0) {
                                for (let j = 0; j < len; j++) {
                                    ...
                                    if (
                                        decryptShareId == shareInfo[i].shareId
                                    ) {
                                        txn.executeSql(
                                            'update ' +
                                                tblName +
            ...
            db.transaction(function(txn) {
                ...
                for (let i = 0; i < arrEachShareId.length; i++) {
                    txn.executeSql(
                        ...
                        [
                            utils.encrypt(
                                resCheckHealth[i].shareId.toString(),
                                passcode
                            ),
                            utils.encrypt(
                                sharesInfo[i].shareStage.toString(),
                                passcode
                            ),
                            utils.encrypt(fulldate.toString(), passcode),
                            arrEachShareId[i]
                        ...
                        (tx, results) => {
                            ...
                            if (len > 0) {
                                for (let j = 0; j < len; j++) {
                                    ...
                                    let encpRecordId = results.rows.item(j)
                                        .recordId;
        ...
        db.transaction(function(txn) {
            txn.executeSql(
                ...
                [
                    utils.encrypt(fulldate.toString(), passcode),
                    utils.encrypt(
                        JSON.stringify(keeperInfo).toString(),
                        passcode
                    ),
                    utils.encrypt(
                        JSON.stringify(urlScript).toString(),
                        passcode
                    ),
                    utils.encrypt(
                        JSON.stringify(decrShare).toString(),
                        passcode
                    ),
                    utils.encrypt(
                    ...
                    utils.encrypt(
                        JSON.stringify(nonPMDDData).toString(),
                        passcode
                    ),
