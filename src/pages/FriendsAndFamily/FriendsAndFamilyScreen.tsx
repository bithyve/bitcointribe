...
> {
  ...
  componentDidUpdate(prevProps, prevState) {
    requestAnimationFrame(() => {
      if (prevProps.trustedContacts != this.props.trustedContacts) {
  ...
  updateAddressBook = async () => {
    ...
    for (const channelKey of Object.keys(trustedContacts)) {
      ...
      const isGuardian = [
        TrustedContactRelationTypes.KEEPER,
        TrustedContactRelationTypes.KEEPER_WARD,
        TrustedContactRelationTypes.PRIMARY_KEEPER,
      ...
      if (contact.isActive) {
        if (isGuardian || isWard) {
          if (
            isGuardian &&
            contact.contactDetails.contactName != "Personal Copy" &&
            contact.contactDetails.contactName != "Personal Device 1" &&
            contact.contactDetails.contactName != "Personal Device 2" &&
            contact.contactDetails.contactName != "Personal Device 3"
          )
            keepers.push(
  ...
  renderContactItem = ({
    ...
    return (
      ...
      >
        ...
        >
          {contactDescription.displayedName.split(" ")[0] + " "}{" "}
        </Text>
      </TouchableOpacity>
    );
  };
  renderContactListItem = ({
    ...
    return (
      ...
      >
        <FriendsAndFamilyContactListItemContent
          contact={contactDescription}
          index={index}
        />
      </ListItem>
    ...
    return (
      ...
      >
        ...
        <Text style={styles.subTitle}>
          Add a new contact, or invite a ward Lorem ipsum dolor sit amet,
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                activeIndex === 0 ? Colors.lightBlue : Colors.backgroundColor1,
            },
          ]}
        >
            ...
            >
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      activeIndex === 0 ? Colors.white : Colors.textColorGrey,
                  },
                ]}
              >
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            {
              backgroundColor:
                activeIndex === 1 ? Colors.lightBlue : Colors.backgroundColor1,
              marginTop: 0,
            },
          ]}
        >
            ...
            >
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      activeIndex === 1 ? Colors.white : Colors.textColorGrey,
                  },
                ]}
              >
        ...
        >
          ...
          >
            ...
            >
              Gift Sats when sending invite Gift Sats when sending invite Gift
              Sats when sending invite
            </Text>
          </View>
          {/* {isSelected && ( */}
  ...
  render() {
    ...
    const { keepers, keeping, otherContacts, showLoader, showIndicator } =
      this.state;
    return (
        <SafeAreaView
          style={{
            ...
            refreshControl={
              <RefreshControl
                ...
                onRefresh={() => {
                  syncPermanentChannels({
                    permanentChannelsSyncKind:
                      PermanentChannelsSyncKind.EXISTING_CONTACTS,
                    metaSync: true,
                  });
                }}
              />
