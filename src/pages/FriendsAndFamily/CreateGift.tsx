...
const CreateGift = ({ navigation }) => {
  ...
  const renderErrorModal = () => {
    return <View style={{
      ...
      <View style={{
        ...
        <View style={{ justifyContent: 'flex-start', marginStart: wp(-4) }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Image source={require('../../assets/images/loader.png')} style={{
  ...
  const accountElement = (
    ...
    activeOpacity = 0,
    width = '90%',
    message = 'Sats would be deducted from',
  ) => {
    return <TouchableOpacity
      style={{ ...styles.accountSelectionView, width: width }}
