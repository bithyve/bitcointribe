...
import BlueBack from '../../assets/images/backBlue.svg'
...
const CreateGift = ( { navigation }: Props ) => {
  ...
  useEffect( () => {
    setInitGiftCreation( false )
    setShowLoader( false )
    console.log('giftCreationStatus' + giftCreationStatus)
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* <Text style={{
          color: Colors.gray3, fontSize: RFValue( 12 ), fontFamily: Fonts.RobotoSlabRegular
        ...
        {/* <View>
        <Text style={{
          color: Colors.blue, fontSize: RFValue( 18 ), fontFamily: Fonts.RobotoSlabRegular
        }}>Customize Gift</Text>
        <Text style={{
          color: Colors.gray3, fontSize: RFValue( 12 ), fontFamily: Fonts.RobotoSlabRegular
        }}>Lorem ipsum dolor Lorem dolor sit amet, consectetur dolor sit</Text>
  ...
  const accountElement = (
    ...
    width = '90%',
    message = `${
      currencyKind === CurrencyKind.BITCOIN ? 'Bitcoin' : 'Money'
              ...
              <View>
                <Text
                  style={{
                    ...
                    fontSize: height < 720 ? RFValue( 18 ) : RFValue( 22 ),
                    letterSpacing: 0.01,
                    marginLeft: 20,
                    fontFamily: Fonts.RobotoSlabRegular,
                  }}
                ...
                <Text
                  style={{
                    ...
                    fontSize: height < 720 ? RFValue( 8 ) : RFValue( 10 ),
                    letterSpacing: 0.01,
                    marginLeft: 20,
                    fontFamily: Fonts.RobotoSlabRegular,
                  }}
                >
                  Send it to anyone via a link or QR within the app.
                </Text>
              </View>
              <TouchableOpacity
                style={{
...
const styles = StyleSheet.create( {
  ...
  errorText: {
    fontFamily: Fonts.RobotoSlabMediumItalic,
    color: Colors.red,
