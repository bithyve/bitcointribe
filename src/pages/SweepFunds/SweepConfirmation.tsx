...
> {
  ...
  setCurrencyCodeFromAsync = async () => {
    const currencyToggleValueTmp = this.props.currencyToggleValue
          ...
          <View style={styles.transactionPriorityView}>
            ...
            {!this.isSendMax && <View style={styles.priorityTableContainer}>
              <View style={styles.priorityValues}>
                ...
                />
                <Text style={{
                  ...styles.priorityTableText, marginLeft: wp( '2%' )
                }}>
                  Medium
                </Text>
              </View>
            ...
            {!this.isSendMax && <View style={{
              ...styles.priorityTableContainer, borderBottomWidth: 0, borderColor: Colors.borderColor,
            }}>
              <View style={styles.priorityValues}>
                <RadioButton
                  size={15}
