...
class Launch extends Component<LaunchScreenProps, LaunchScreenState> {
  ...
  componentDidMount = async() => {
    ...
    this.appStateSubscribe = AppState.addEventListener( 'change', this.handleAppStateChange )
    this.linkStateSubscribe = Linking.addEventListener( 'url', this.handleDeepLinkEvent )
