                ...
                <View style={{ ...styles.modalContentContainer, height: '100%' }}>
                    <View style={{ height: '100%' }}>
                        <View style={{ marginTop: hp('3.5%'), marginBottom: hp('2%'), }}>
                            ...
                            <Text style={styles.commModeModalInfoText}>Congratulations! You can now use your <Text style={{ fontFamily: Fonts.FiraSansMediumItalic }}>Wallet</Text></Text>
                        </View>
                            ...
                            <View style={styles.box}>
                                <View style={{ justifyContent: "center", paddingLeft:20}}>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
                                        ...
                                        />
                                        <Text style={{...CommonStyles.homepageAmountText, color: Colors.black, }}>2,065,000</Text>
                                        <Text style={{ ...CommonStyles.homepageAmountUnitText, color: Colors.borderColor, }}>sats</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                        <Text style={{ ...styles.commModeModalInfoText, marginBottom: hp('3.5%') }}>{"Your wallet has been successfully\ncreated and backed up"}</Text>
                    </View>
                </View>
            </View>
