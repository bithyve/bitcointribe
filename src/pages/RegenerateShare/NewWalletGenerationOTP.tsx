                    ...
                    <View style={{ ...styles.modalContentContainer, height: '100%' }}>
                        <View style={{ height: '100%' }}>
                            <View style={{ marginTop: hp('3.5%'), marginBottom: hp('2%'), }}>
                                <Text style={styles.commModeModalHeaderText}>{"Enter OTP for the\nexisting secure account"}</Text>
                                <Text style={styles.commModeModalInfoText}>{"Lorem ipsum dolor sit amet, consectetur adipiscing elit,\nsed do eiusmod tempor incididunt"}</Text>
                            </View>
