...
export default function SetNewPassword( props: { navigation: NavigationProp<ParamListBase>, route: RouteProp<ParamListBase> } ) {
  ...
  const isChange = props.route.params?.isChange
