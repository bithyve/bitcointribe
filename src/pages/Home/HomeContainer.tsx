      ...
      <View style={containerView}>
        <ScrollView style={{
          ...
          {/* <Svg
              ...
              >
                <Defs></Defs>
                <G transform="translate(-163 -274)">
                  <Circle
                    className="prefix__a"
                    cx={4.5}
                    cy={4.5}
                    r={4.5}
                    transform="translate(163 320)"
                  />
                  <Circle
                    className="prefix__a"
                    cx={4.5}
                    cy={4.5}
                    r={4.5}
                    transform="translate(318 308)"
                  />
                  <Path
                    d="M167.502 325.928c24.434 0 19.122-22.118 41.077-22.118s15.935 25.135 47.1 25.135c21.247 0 18.414-17.594 33.286-17.594 7.082 0 15.581-1.163 33.286-1.163"
                    stroke="#707070"
                    strokeWidth={3.274}
                    opacity={0.15}
                    fill="none"
                  ...
                  />
                  <Path
                    d="M167.502 324.994c24.427 0 19.117-28.968 41.066-28.968s15.934 32.918 47.084 32.918c21.241 0 18.409-23.043 33.277-23.043 7.08 0 14.869 6.584 32.569 6.584"
                    stroke="#006db4"
                    strokeWidth={2}
                    fill="none"
                    strokeLinecap="round"
                ...
                <Path
                  className="prefix__d"
                  d="M19.391 0h5.218A5.391 5.391 0 0130 5.391v59.218A5.391 5.391 0 0124.609 70h-5.218A5.391 5.391 0 0114 64.609V5.391A5.391 5.391 0 0119.391 0zM51.391 0h5.218A5.391 5.391 0 0162 5.391v59.218A5.391 5.391 0 0156.609 70h-5.218A5.391 5.391 0 0146 64.609V5.391A5.391 5.391 0 0151.391 0zM83.391 0h5.218A5.391 5.391 0 0194 5.391v59.218A5.391 5.391 0 0188.609 70h-5.218A5.391 5.391 0 0178 64.609V5.391A5.391 5.391 0 0183.391 0zM115.391 0h5.218A5.391 5.391 0 01126 5.391v59.218A5.391 5.391 0 01120.609 70h-5.218A5.391 5.391 0 01110 64.609V5.391A5.391 5.391 0 01115.391 0z"
                />
                <Path
                  d="M147.391 0h5.218A5.391 5.391 0 01158 5.391v59.218A5.391 5.391 0 01152.609 70h-5.218A5.391 5.391 0 01142 64.609V5.391A5.391 5.391 0 01147.391 0z"
                  opacity={0.07}
                  fill="#006db4"
                />
                <Txt className="prefix__f" transform="translate(22 80)">
                  <TSpan x={-8.38} y={0}>
                    {'mon'}
                  </TSpan>
                </Txt>
                <Txt className="prefix__f" transform="translate(54 80)">
                  <TSpan x={-6.324} y={0}>
                    {'tue'}
                  </TSpan>
                </Txt>
                <Txt className="prefix__f" transform="translate(86 80)">
                  <TSpan x={-7.848} y={0}>
                    {'wed'}
                  </TSpan>
                </Txt>
                <Txt className="prefix__f" transform="translate(117.5 80)">
                  <TSpan x={-6.452} y={0}>
                    {'thu'}
                  </TSpan>
                </Txt>
                <Txt
                  ...
                  fontFamily="FiraSans-SemiBold,Fira Sans"
                  fontWeight={600}
                  fontSize={8}
                  letterSpacing=".04em"
                  fill="#006db4"
                ...
                <Path
                  className="prefix__d"
                  d="M179.391 0h5.218A5.391 5.391 0 01190 5.391v59.218A5.391 5.391 0 01184.609 70h-5.218A5.391 5.391 0 01174 64.609V5.391A5.391 5.391 0 01179.391 0zM211.391 0h5.218A5.391 5.391 0 01222 5.391v59.218A5.391 5.391 0 01216.609 70h-5.218A5.391 5.391 0 01206 64.609V5.391A5.391 5.391 0 01211.391 0z"
                />
                <Txt className="prefix__f" transform="translate(181.5 80)">
                  <TSpan x={-5.868} y={0}>
                    {'sat'}
                  </TSpan>
                </Txt>
                <Txt className="prefix__f" transform="translate(214 80)">
                  <TSpan x={-6.856} y={0}>
                    {'sun'}
                  </TSpan>
                </Txt>
