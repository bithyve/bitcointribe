...
export const X_TRANSFER_ST2 = 'X_TRANSFER_ST2';
...
export const xSyncAccounts = (accountsToSync) => {
  return {
...
export const xTransferST1 = (recipients, account) => {
  return {
    type: X_TRANSFER_ST1,
    payload: { recipients, account },
  };
};

export const xTransferST2 = () => {
  return {
    type: X_TRANSFER_ST2,
    payload: {},
  };
