...
export default class PermissionAndroid extends Component {
    ...
    try {
      ...
      try {
        ...
        if (flat_Perm) {
          ...
          else this.props.navigation.push('RestoreSelectedContactsList');
        } else {
  ...
  gotoWallet() {
    try {
      ...
      AsyncStorage.setItem(asyncStorageKeys.rootViewController, 'TabbarBottom');
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1, alignItems: 'center' }}>
                <View>
                  <Text style={[FontFamily.ffFiraSansRegular]}>
                    <IconFontAwe
                      name="circle"
                      size={10}
