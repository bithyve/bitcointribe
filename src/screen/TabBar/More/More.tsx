...
export default class Setting extends React.Component<any, any> {
    ...
    this.setState({
      arr_FirstListItem: [
        ...
        //  },
        {
          title: 'Address Book',
          subTitle:
            'Contacts you have trusted or the ones who have trusted you',
  ...
  click_SecoundMenuItem = async (item: any) => {
    try {
      console.log({ item });
      let url = '';
      if (item.title == "FAQ's") url = 'https:// hexawallet.io/faq';
        ...
        >
          ...
          >
            ...
            >
              <View style={{ margin: 10, marginTop: 30 }}>
                <Text
                  style={[
                    ...
                    { color: '#000000', fontSize: 28, marginLeft: 0 },
                  ]}
                >
                  More
                </Text>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <ImageSVG
                              size={40}
                              source={svgIcon.moreScreen[item.svgIcon]}
                            />
                          </View>
              ...
              <View
                style={{ flex: 0.61, borderRadius: 10, padding: 10, margin: 8 }}
              >
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <List>
                      <ListItem
                        onPress={() => this.click_SecoundMenuItem(item)}
                      >
                        <Left>
              ...
              <View style={{ flex: 0.4, alignItems: 'center', marginTop: 20 }}>
                <Text note style={[FontFamily.ffFiraSansMedium]}>
                  Follow Us
                </Text>
                <View style={{ alignItems: 'center', flexDirection: 'row' }}>
                  <Button
                    ...
                    onPress={() =>
                      this.click_OpenSocialUrl(
                        'https:// twitter.com/HexaWallet',
                      )
                    }
                  >
                    <SvgIcon
                  ...
                  >
                    <SvgIcon name="linkedin-logo" color="#BABABA" size={20} />
                  </Button>
                  <Button
                    transparent
                    style={styles.btnSocial}
                    onPress={() =>
                      this.click_OpenSocialUrl('https:// medium.com/bitbees')
                    }
                  >
                    <SvgIcon name="medium-size" color="#BABABA" size={20} />
                  </Button>
                </View>
                <Text note>
                  © 2019 All Rights Reserved. Bithyve | www.bithyve.com
                </Text>
              </View>
            </KeyboardAwareScrollView>
          </SafeAreaView>
