...
class Wallet extends React.Component {
            ...
            if (resEncryptBuddyStaticNonPMDD.status == 200) {
              ...
              if (rescreateMetaShare3.status == 200) {
                ...
                if (qrcode4share.status == 200) {
                  ...
                  console.log({ temp });
                  let resGenerate4thsharepdf = await this.genreatePdf(
                    temp,
                  ...
                  if (resGenerate4thsharepdf != '') {
                    ...
                    if (rescreateMetaShare4.status == 200) {
                      ...
                      if (qrcode5share.status == 200) {
                        ...
                        let resGenerate5thsharepdf = await this.genreatePdf(
                          temp,
                          walletDetails.walletType.split(' ')[0] +
                            ' Hexa Wallet Share 5',
                          walletDetails.walletType.split(' ')[0] +
  ...
  getCorrectFormatStirng(share1: string) {
    try {
      share1 = share1.split('"').join('Dquote');
      share1 = share1.split(':').join('Qutation');
      share1 = share1.split('{').join('Lbrace');
      share1 = share1.split('}').join('Rbrace');
      share1 = share1.split('/').join('Slash');
      share1 = share1.split(',').join('Comma');
      share1 = share1.split("'").join('Squote');
  ...
  //  genreatePdf2 = async (data:any) =>{
  //   let resSecoundPdf = await this.genreatePdf2({
  //      qrCode5,
  //      arrShare5,
  //      qrCode6,
  //      arrShare6,
  ...
  //      height: 842,
  //      width: 595,
  //      html:"<h3 style='text-decoration: underline;'>Part 5<h3>"+
  //        new QRCode( data.qrCode5).svg() +
  //        "<p align='center'>" + data.arrShare5[ 0 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare5[ 1 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare5[ 2 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare5[ 3 ].toString() + "</p>" +
  //    "<h3 style='text-decoration: underline;'>Part 6<h3>" +
  //        new QRCode( data.qrCode6).svg() +
  //        "<p align='center'>" + data.arrShare6[ 0 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare6[ 1 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare6[ 2 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare6[ 3 ].toString() + "</p>" +
  //      "<h3 style='text-decoration: underline;'>Part 7<h3>" +
  //        new QRCode( data.qrCode7).svg() +
  //        "<p align='center'>" + data.arrShare7[ 0 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare7[ 1 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare7[ 2 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare7[ 3 ].toString() + "</p>" +
  //      "<h3 style='text-decoration: underline;'>Part 8<h3>" +
  //        new QRCode( data.qrCode8).svg() +
  //        "<p align='center'>" + data.arrShare8[ 0 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare8[ 1 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare8[ 2 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrShare8[ 3 ].toString() + "</p>"+
  //      "<h3 style='text-decoration: underline;'>Secondary Xpub (Encrypted):<h3>" +
  //        new QRCode( data.secondaryXpub ).svg() +
  //      "<p align='center'>Scan the above QR Code using your HEXA wallet in order to restore your Secure Account.</p>" +
  //      "<p>2FA Secret:<p><br/>" +
  //        new QRCode( data.qrData ).svg() +
  //        "<p align='center'>" + data.secret2FA + "</p>" +
  //      "<p>Following assets can be used to recover your funds using the open - sourced ga - recovery tool.</p><br/><br/>" +
  //      "<p>Secondary Mnemonic:<p>" +
  //        "<p align='center'>" + data.firstArrSecondaryMnemonic + "</p>" +
  //        "<p align='center'>" + data.secoundArrSecondaryMnemonic + "</p><br/>" +
  //      "<p>BitHyve Xpub:<p>" +
  //        "<p align='center'>" + data.arrBhXpub[ 0 ].toString() + "</p>" +
  //        "<p align='center'>" + data.arrBhXpub[ 1 ].toString() + "</p>",
  //      fileName: data.pdfFileName + " 2",
  //      directory: 'Documents',
  //        };
  //        let file = await RNHTMLtoPDF.convert( options );
  //       console.log( { file } )
  //    if ( Platform.OS == "ios" ) {
  //      var PdfPassword = NativeModules.PdfPassword;
  //      PdfPassword.addEvent( "/" + data.pdfFileName + " 2.pdf", data.password );
  //    } else {
  //      this.setPdfAndroidPasswrod( file.filePath, data.password );
  //    }
