        ...
        <View style={{ flex: 1, marginTop: -20 }}>
          <List>
            <ListItem style={{ marginRight: 18 }}>
              ...
              <Body style={{ flex: 1 }}>
                <Text style={[FontFamily.ffFiraSansBold, { fontSize: 16 }]}>
                  {item.accountName}
                </Text>
  ...
  render() {
    ...
    return (
      <Container>
        ...
        >
          <HeaderTitle title="Send" pop={() => this.props.navigation.pop()} />
          <SafeAreaView
            ...
            >
                ...
                <View style={[styles.itemQuestionPicker]}>
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <Button
                      ...
                      style={{ flex: 0.15 }}
                      onPress={() => {
                        this.props.navigation.push('SendPaymentAddressScan', {
                          onSelect: this.getAddressWithBal.bind(this),
                        });
                      }}
                    >
              ...
              <View style={{ flex: 1 }}>
                <Text note style={{ textAlign: 'center', margin: 10 }}>
                  Transaction fee will be calculated in the next step according
                  to the amount of money being sent.
                </Text>
