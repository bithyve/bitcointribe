...
// TODO: Custome Model
import { ModelRestoreAssociateContactList } from 'hexaComponent/Model';
        ...
        >
          ...
          >
            ...
            >
              <Text
                note
                style={{ textAlign: 'center', marginTop: 10, marginRight: 10 }}
              >
                Please enter the six digit OTP the owner of secret shared with
                you
              </Text>
              ...
              <View style={styles.viewBtnProceed}>
                ...
                <FullLinearGradientButton
                  style={[
                    this.state.statusConfirmBtnDisable == true
                      ? { opacity: 0.4 }
                      : { opacity: 1 },
                    { borderRadius: 5 },
                  ]}
