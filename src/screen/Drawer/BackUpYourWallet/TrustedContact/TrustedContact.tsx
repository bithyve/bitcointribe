...
import { FullLinearGradientShareButton } from 'hexaComponent/LinearGradient/Buttons';
  ...
  async componentWillMount() {
    ...
    if (otp != undefined) {
      ...
      if (
        ...
        data.sssDetails.shareStage == 'Bad'
      ) {
        this.setState({
        ...
        >
          ...
          >
            <View style={{ flex: 0.1, margin: 20 }}>
              ...
              >
                Health and history of the share will be shared with{' '}
              </Text>
            </View>
            <View style={Platform.OS == 'ios' ? { flex: 0.7 } : { flex: 0.8 }}>
              ...
              <View style={{ flex: 1, alignItems: 'center', marginRight: 20 }}>
                <Text style={[FontFamily.ffFiraSansMedium, { fontSize: 17 }]}>
                  {data.givenName} {data.familyName}
                </Text>
                <Text
                  style={[
                    FontFamily.ffFiraSansMedium,
                    { fontSize: 14, color: data.statusMsgColor },
                  ]}
                >
                  {data.statusMsg}
                </Text>
            ...
            {renderIf(this.state.flag_OtpCodeShowStatus == true)(
              <View
                style={[
                  Platform.OS == 'ios' ? { flex: 1 } : { flex: 1 },
                  { marginLeft: 5, marginRight: 5 },
                ]}
              >
                <Text note style={{ textAlign: 'center' }}>
                  OTP and share expires in{' '}
                  {parseInt(expaire.trustedContactScreen.expaire_otptime) / 60}{' '}
                  minutes
                </Text>
                <View
                  style={{
            ...
            {renderIf(this.state.flag_OtpCodeShowStatus != true)(
              <View
                style={Platform.OS == 'ios' ? { flex: 0.6 } : { flex: 0.8 }}
              >
                <Text
                  note
                  style={[FontFamily.ffFiraSansMedium, { textAlign: 'center' }]}
                >
                  Select method by which you want to share secret
                </Text>
                <FullLinearGradientShareButton
                  click_Done={(title: string) => {
                    this.click_CloseModel();
                ...
                <View style={{ alignItems: 'center' }}>
                  <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                    <Button
                      ...
                      onPress={() =>
                        this.click_SentRequest('SMS', data.phoneNumbers)
                      }
                    >
                      <View
                        style={{
                    ...
                    <Button
                      ...
                      style={{ alignItems: 'center', flex: 1 }}
                      onPress={() =>
                        this.click_SentRequest('EMAIL', data.emailAddresses)
                      }
                    >
                      <View
                        style={{
