...
import { ModelHealthCheckMnemonicFirstWord, ModelHealthCheckMnemonicSecoundWord, ModelHealthCheckMnemonicThirdWord, ModelHeackCheckMnemonicSucessBackedUp } from "hexaComponent/Model";
    ...
    render() {
        ...
        return (
            <View style={ styles.container }>
                <StatusBar backgroundColor={ colors.white } flagShowStatusBar={ false } barStyle="dark-content" />
