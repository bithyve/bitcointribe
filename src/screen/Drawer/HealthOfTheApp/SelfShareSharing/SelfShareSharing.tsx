        ...
        Mailer.mail(
          {
            ...
            recipients: [''],
            body:
              '<b>Please find attached the 4th share pdf, it is password protected by the answer to the security question.</b>',
            isHTML: true,
            attachment: {
          ...
          (error, event) => {
            if (event == 'sent') {
              ...
              alert.simpleOkActionWithPara(
                'Success',
                'Please permanently delete the email from the sent folder',
                this.updateHistory(data, 'Shared.', ''),
              );
              this.setState({
                btnShareTitle: 'Confirm',
      ...
      for (let i = 0; i < sssDetails.length; i++) {
        ...
        data.updatedAt =
          sssDetails[i].sharedDate == ''
            ? 0
            : parseInt(sssDetails[i].sharedDate);
        ...
        >
          ...
          >
            <View style={{ flex: 0.1, margin: 20 }}>
              ...
              >
                Share this pdf to an email/cloud which you can
              </Text>
              <Text
                note
                style={[FontFamily.ffFiraSansMedium, { textAlign: 'center' }]}
              >
                access if required to hold this secret for safekeeping{' '}
              </Text>
            </View>
            <View style={{ flex: 2 }}>
              <FlatList
            ...
            <View style={{ flex: Platform.OS == 'ios' ? 0.5 : 0.6 }}>
              <Text
                ...
                style={[FontFamily.ffFiraSansMedium, { textAlign: 'center' }]}
              >
                Do not share this pdf with anyone other than your email/cloud
              </Text>
                      ...
                      arr_ModelBottomTwoButtons: [
                        {
                          ...
                          svgIcon1:
                            Platform.OS == 'ios' ? 'reshareSVG' : 'resharePNG',
                          svgIcon2:
                            Platform.OS == 'ios'
                              ? 'recreateSVG'
                              : 'recreatePNG',
