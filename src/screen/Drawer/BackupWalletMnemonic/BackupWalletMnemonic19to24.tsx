...
export default class BackupWalletMnemonic19to24 extends React.Component<
  any,
  any
> {
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.viewPagination}>
            ...
            >
              Write down these words in the order indicated
            </Text>
            <Text
              note
              style={[
            ...
            >
              You will be asked to confirm these words later
            </Text>
          </View>
                ...
                <List>
                  <ListItem noBorder style={{ height: 55 }}>
                    <View style={[styles.mnemonicItem]}>
                      ...
                      <Text style={{ flex: 1, color: '#838383' }}>
                        {item.title}
                      </Text>
                    </View>
                  </ListItem>
