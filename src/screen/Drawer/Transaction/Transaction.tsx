...
import { FullLinearGradientTransactionScreenThreeOpt } from 'hexaComponent/LinearGradient/Buttons';
// TODO: Custome Alert
      ...
      <View style={{ padding: 5 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flex: 1, padding: 5 }}>
            ...
            <Text style={{ color: '#8B8B8B', fontSize: 12, fontWeight: '600' }}>
              {'-'}
            </Text>
          </View>
        ...
        >
          ...
          <View style={styles.amountView}>
            ...
            >
              <Text
                style={{ color: '#2F2F2F', fontSize: 20, fontWeight: 'bold' }}
              >
                {item.amount}
                <Text note> sats</Text>
              </Text>
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            >
              <View
                style={{ flexDirection: 'row', margin: StBar.currentHeight }}
              >
