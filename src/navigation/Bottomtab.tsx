...
function HomeStack() {
  return (
    ...
    >
      <Stack.Screen name="HomeRoot" component={HomeContainer} options={{ header: null }} />
      <Stack.Screen name="AddNewAccount" component={AddNewAccountStack} options={{ header: null }} />
      ...
      <Stack.Screen name="PlaceWyreOrder" component={WyreOrderFormScreen} options={{ title: 'Buy with Wyre' }} />
      <Stack.Screen name="PlaceRampOrder" component={RampOrderFormScreen} options={{ title: 'Buy with Ramp' }} />
      <Stack.Screen name="AllTransactions" component={AllTransactionsStack} options={{ header: null }} />
      <Stack.Screen name="FriendsAndFamily" component={FriendsAndFamilyScreen} options={{ header: null }} />
      <Stack.Screen name="QRScanner" component={QRStack} options={{ header: null }} />
      <Stack.Screen name="MoreOptions" component={MoreOptionsStack} options={{ header: null }} />
    </Stack.Navigator>
  )
}
