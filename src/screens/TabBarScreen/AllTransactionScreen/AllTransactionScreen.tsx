...
export default class AllTransactionScreen extends React.Component {
  ...
  async getTransaction() {
    ...
    let regularAccountData = await utils.getRegularAccountObject();
    const regularAccountTransactions = await regularAccountData.getTransactions();
    this.setState({ recentTransactions: regularAccountTransactions.data.transactions.transactionDetails })
