...
export default class Restore4And5SelfShareQRCodeScreen4 extends React.Component<Props, any> {
        ...
        try {
            ...
            if ( type == "iCloud" ) {
                if ( firstChar == "c04" ) {
                    ...
                    if ( flag_ReadQRCode ) {
                        alert.simpleOkAction( "Oops", "Please scan share 4 qrcode.", this.click_resetFlag );
                        flag_ReadQRCode = false;
                    }
                }
            } else {
            ...
            <Container>
                <View style={ styles.container }>
                    { renderIf( flag_qrcode == false )(
                        ...
                        >
                            <Text style={ { color: "#000000" } }>Tab To Scan share 4</Text>
                        </Button>
                    ) }
