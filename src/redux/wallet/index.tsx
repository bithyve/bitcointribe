...
export const watcherSetupAccounts = sagaWatcherHelper( workerSetupAccounts, SETUP_ACCOUNTS );
export const watcherRegularAccount = sagaWatcherHelper( workerRegularAccount, CREATE_REGULAR_ACCOUNT );
export const watcherSecureAccount = sagaWatcherHelper( workerSecureAccount, CREATE_SECURE_ACCOUNT );
