...
import {
  ...
  BIT_API_URLS_RELAY_STAGING,
  BIT_API_URLS_SIGNING_SERVER_STAGING,
  ...
  BIT_SHARE_HEALTH_TIME_SLOT1_DEV,
...
class Config {
  ...
  public REQUEST_TIMEOUT: number = parseInt(BIT_REQUEST_TIMEOUT, 10);
  ...
  public BH_SERVERS = {
    ...
    STAGING: {
      RELAY: BIT_API_URLS_RELAY_STAGING,
      SIGNING_SERVER: BIT_API_URLS_SIGNING_SERVER_STAGING,
    },
    PROD: {
  ...
  public HEALTH_STATUS = {
    ...
    TIME_SLOTS: {
      SHARE_SLOT1: parseInt(BIT_SHARE_HEALTH_TIME_SLOT1_DEV, 10),
      SHARE_SLOT2: parseInt(BIT_SHARE_HEALTH_TIME_SLOT2_DEV, 10),
    },
  };
