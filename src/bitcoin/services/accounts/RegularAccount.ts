...
export default class RegularAccount {
  ...
  public getAddress = async () => this.hdWallet.getReceivingAddress();

  public getBalance = async () => this.hdWallet.fetchBalance();

  public getTransactionDetails = async (txHash: string) =>
    this.hdWallet.fetchTransactionDetails(txHash);

  public getTransactions = async () => this.hdWallet.fetchTransactions();
