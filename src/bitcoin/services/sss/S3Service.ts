...
export default class S3Service {
  ...
  public createTransferShare = (encryptedShare: any, tag?: string) => {
    ...
    console.log({ encryptedShare });
    const { share, otp } = this.sss.encryptViaOTP(encryptedShare);
    console.log(otp);
    return {
      share,
      otp
