...
export const getCurrencyImageByRegion = (currencyCode, type) =>{
  if(currencyCode == 'USD' || currencyCode == 'AUD' || 
    currencyCode == 'BBD' || currencyCode == 'BSD' ||
    currencyCode == 'BZD' || currencyCode == 'BMD' ||
    currencyCode == 'BND' || currencyCode == 'KHR' || 
    currencyCode == 'CAD' || currencyCode == 'KYD' ||
    currencyCode == 'XCD' || currencyCode == 'FJD' ||
    currencyCode == 'GYD' || currencyCode == 'HKD' || 
    currencyCode == 'JMD' || currencyCode == 'LRD' ||
    currencyCode == 'NAD' || currencyCode == 'NZD' ||
    currencyCode == 'SGD' || currencyCode == 'SBD' || 
    currencyCode == 'SRD' || currencyCode == 'TWD' ||
    currencyCode == 'TTD' || currencyCode == 'TVD' ||
    currencyCode == 'ZWD'){
    if(type == 'light'){
  ...
  if( currencyCode == 'EGP' || currencyCode == 'FKP' ||
    currencyCode == 'GIP' || currencyCode == 'GGP' ||
    currencyCode == 'IMP' || currencyCode == 'JEP' ||
    currencyCode == 'SHP' || currencyCode == 'SYP' ||
    currencyCode == 'GBP'){
    if(type == 'light'){
