...
export default class RgbSubAccountInfo
implements HexaSubAccountDescribing {
  ...
  kind: SubAccountKind = SubAccountKind.RGB_ACCOUNT;
  sourceKind: SourceAccountKind = SourceAccountKind.REGULAR_ACCOUNT;
  type: AccountType = AccountType.RGB_ACCOUNT
  ...
  defaultDescription = 'RGB Account';
  ...
  constructor( {
    ...
    accountShellID = null,
    instanceNumber = null,
    defaultTitle = 'RGB Account',
    defaultSubTitle= 'RGB account',
    balances = {
