...
export default class Eclair {
    ...
    getNewAddress = () =>
      this.api( 'getnewaddress' ).then( ( address: any ) => ( {
        address
      } ) );
    ...
    connectPeer = ( data: any ) =>
      this.api( 'connect', {
        uri: data.addr.pubkey + '@' + data.addr.host
      } );
    listNode = () => {};
    ...
    payLightningInvoice = ( data: any ) => {
      ...
      return this.api( 'payinvoice', params )
        .then( ( payId: any ) => this.api( 'getsentinfo', {
          id: payId
        } ) )
        .then( ( attempts: any ) => {
