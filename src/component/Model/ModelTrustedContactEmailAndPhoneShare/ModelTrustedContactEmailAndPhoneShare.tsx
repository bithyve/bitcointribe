          ...
          <View style={styles.viewModelBody}>
            ...
            >
              {renderIf(contactDetails.thumbnailPath != '')(
                <Avatar
                  medium
                  rounded
                  source={{ uri: contactDetails.thumbnailPath }}
                />,
              )}
              {renderIf(contactDetails.thumbnailPath == '')(
                <Avatar
              ...
              <Text style={[FontFamily.ffFiraSansMedium, { marginLeft: 10 }]}>
                {contactDetails.givenName} {contactDetails.familyName}
              </Text>
            </View>
            <View
              style={{
                  ...
                  >
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                      ...
                      <View style={{ flex: 2, flexDirection: 'column' }}>
                        <Text note style={[FontFamily.ffFiraSansRegular]}>
                          {item.label}
                        </Text>
                        <Text
                          style={[
            ...
            <View style={{ flex: 1, justifyContent: 'flex-end' }}>
              <FullLinearGradientButton
                click_Done={() =>
                  this.props.click_Confirm(this.state.selected_category)
                }
