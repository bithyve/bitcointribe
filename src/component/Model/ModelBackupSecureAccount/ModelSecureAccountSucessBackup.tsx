...
export default class ModelSecureAccountSucessBackup extends Component<Props, any> {
                ...
                <View style={ [
                    ...
                    <View style={ styles.viewModelBody }>
                        <View style={ { flexDirection: "row", flex: 0.6, margin: 20 } }>
                            ...
                            } ] }>Secure Wallet Successfully Backed Up.</Text>
                        </View>
                        ...
                        <View style={ { flex: 1, alignItems: "center", justifyContent: "flex-end" } }>
                            ...
                            <Text note style={ [ styles.txtNotes, { textAlign: "center" } ] }>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</Text>
                        </View>
