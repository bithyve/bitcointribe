                ...
                <View style={ [
                    ...
                    <View style={ styles.viewModelBody }>
                        <View style={ { flexDirection: "row", flex: 0.5 } }>
                            <Text style={ [ FontFamily.ffFiraSansMedium, { fontSize: 20, color: "#2F2F2F", flex: 5, textAlign: "center", marginTop: 10 } ] }>{ walletName } wallet has selected you as trusted contact</Text>
                        ...
                        <View style={ { flex: 1, alignItems: "center", justifyContent: "flex-start" } }>
                            <Text note style={ [ FontFamily.ffFiraSansMedium, { textAlign: "center", fontSize: 12, marginBottom: 20 } ] }>This secret is required if { walletName } want to retore wallet in case of loss</Text>
                            <Avatar medium rounded title={ walletName.charAt( 0 ) } />
                            <Text style={ FontFamily.ffFiraSansMedium } note>{ walletName }</Text>
                            <Text style={ [ FontFamily.ffFiraSansRegular, { textAlign: "center", marginTop: 10 } ] }>This share will now be stored in More> Address book. Tap on it to return share when requested by owner. An OTP will also be displayed post sharing.</Text>
                        </View>
                        <View style={ { flex: 1, justifyContent: "flex-end" } }>
                            <Text note style={ [ FontFamily.ffFiraSansMedium, { textAlign: "center", fontSize: 12 } ] }>You are requested to open the Hexa application once in two weeks to make sure the secret is still accessible</Text>
                            <Button
