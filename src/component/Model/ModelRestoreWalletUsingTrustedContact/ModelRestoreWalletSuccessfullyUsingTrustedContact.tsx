...
export default class ModelRestoreWalletSuccessfullyUsingTrustedContact extends Component<
  Props,
  any
> {
          ...
          <View style={styles.viewModelBody}>
            ...
            >
              <Image
                ...
                source={images.RestoreWalletUsingTrustedContact.successImage}
              />
            </View>
            <View
              style={{
            ...
            >
              <Text note style={[styles.txtNotes, { textAlign: 'center' }]}>
                Congratulations! Your wallet is successfully restored
              </Text>
              <Text note>
                {data.length != 0 ? data[0].walletName : 'Hexa Wallet'}
              </Text>
              <Text note style={[styles.txtNotes, { textAlign: 'center' }]}>
                Restore your secure account now You can opt to do it later
              </Text>
            </View>
