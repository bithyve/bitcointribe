  ...
  _renderDetailsItem = ({ item, index }) => {
    return (
      ...
      >
        ...
        <Text style={{ color: '#151515', fontSize: 14, fontWeight: '600' }}>
          {item.value}
        </Text>
      </TouchableOpacity>
    );
        ...
        <TouchableOpacity activeOpacity={1} style={styles.container}>
          ...
          >
                  ...
                  <ImageSVG
                    ...
                    source={
                      svgIcon.walletScreen[
                        selectedTransaction.accountType == 'Regular'
                          ? Platform.OS == 'ios'
                            ? 'dailyAccountSVG'
                            : 'dailyAccountPNG'
                          : Platform.OS == 'ios'
              ...
              >
                <View style={styles.amountView}>
                  ...
                  >
                    ...
                    >
                      {selectedTransaction.NumberofConfirmations}
                    </Text>
                  </View>
                  <View>
                    <Icon
            ...
            <View style={{ marginTop: 5, paddingHorizontal: 10 }}>
              <Text
                style={{ color: '#B7B7B7', fontWeight: '600', fontSize: 14 }}
              >
                {'Transaction Details'}
              </Text>
            </View>
