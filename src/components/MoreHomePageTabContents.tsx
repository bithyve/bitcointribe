...
export default function MoreHomePageTabContents( props ) {
    const [ addData, setAddData ] = useState( [
        ...
        {
            title: 'Wallet Settings', image: require( '../assets/images/icons/settings.png' ), info: `Wallet setting and preferences`,
        },
        // {
    ...
    return ( <View style={ { ...styles.modalContentContainer, height: '100%', } }>
        <View>
            ...
            <View style={ {
                ...
                <AppBottomSheetTouchableWrapper onPress={ () => openLink("https://hexawallet.io/terms-of-service/") }>
