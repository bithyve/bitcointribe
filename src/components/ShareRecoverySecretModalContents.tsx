    ...
    <View style={{
      ...
      <View style={styles.contactProfileView}>
        <View style={{
          ...
          <View style={{
            flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', flex: 1, backgroundColor: Colors.backgroundColor, height: 80, marginLeft: 60, overflow: 'hidden', position: 'relative', borderRadius: 10
          }}>
            <View style={{
              marginLeft: 10
            }}>
      ...
      }}>{props.sunInfoText}</Text>
      <View style={{
        justifyContent: 'center', alignItems: 'center', marginBottom: hp( '5%' ), paddingLeft: 20, paddingRight: 20, paddingBottom: 20
      }}>
        {props.shareVia == 'qr' ?
          <TouchableOpacity onPress={() => props.onPressRequest()} style={{
            backgroundColor: Colors.blue, height: wp( '13%' ), borderRadius: 10, width: wp( '50%' ), justifyContent: 'center', alignItems: 'center'
          }}>
