                ...
                >
                    <View style={styles.viewModelBody}>
                        ...
                        >
                            ...
                            >
                                Enter the next in sequence verification code
                                generated on Google Authentication for your Hexa
                                Wallet
                            </Text>
                            <CodeInput
                                ref="codeInputRef1"
                                ...
                                inactiveColor={
                                    this.state.passcodeStyle[0].inactiveColor
                                }
                                className="border-box"
                                cellBorderWidth={
                                    this.state.passcodeStyle[0].cellBorderWidth
                                }
                                autoFocus={false}
                        ...
                        <View style={{ flex: 0.7, justifyContent: 'flex-end' }}>
                            <Text
                                ...
                                style={{ textAlign: 'center', margin: 20 }}
                            >
                                In case you do not have the code, refer to the
                                PDF downloaded while backing up secure account
                            </Text>
