...
export default class ModelHealthCheckMnemonicSecoundWord extends Component<
    Props,
    any
> {
                        ...
                        <View style={styles.viewModelBody}>
                            ...
                            >
                                ...
                                <View style={styles.viewCodeInput}>
                                    ...
                                    >
                                        Enter the <Text>{number}</Text> word
                                        from the mnemonic.
                                    </Text>
                                    <Input
                            ...
                            >
                                ...
                                >
                                    Refer to the 12-24 word mnemonic that you
                                    noted down while backing up your wallet.
                                </Text>
