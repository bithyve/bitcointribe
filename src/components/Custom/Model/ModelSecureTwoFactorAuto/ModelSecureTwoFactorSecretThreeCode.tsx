...
export default class ModelSecureTwoFactorSecretThreeCode extends Component<
    Props,
    any
> {
    constructor(props: any) {
        ...
        this.state = {
            ...
            otp: '',
            message:
                'First three letter your secure account secret for the PDF',
            passcodeStyle: [
                {
    ...
    componentWillReceiveProps(nextProps: any) {
        ...
        if (data != null) {
            ...
            if (date % 2 == 0) {
                ...
                message =
                    'Last three letter your secure account secret for the PDF';
            }
                    ...
                    >
                        <View style={styles.viewModelBody}>
                            ...
                            >
                                <Image
                                    source={
                                        images.backupSecureTwoFactorAuto.icon
                                    }
                                    style={{
                                        width: 80,
                                        height: 80,
                                ...
                                <Text note style={{ textAlign: 'center' }}>
                                    Enter the first three digits of your 2FA
                                    secret key from secure PDF
                                </Text>
                                <View style={styles.viewCodeInput}>
                                    <CodeInput
                                        ...
                                        codeLength={3}
                                        activeColor={
                                            passcodeStyle[0].activeColor
                                        }
                                        inactiveColor={
                                            passcodeStyle[0].inactiveColor
                                        }
                                        className="border-box"
                                        cellBorderWidth={
                                            passcodeStyle[0].cellBorderWidth
                                        }
                                        compareWithCode={otp}
                                        autoFocus={false}
                                    ...
                                    />
                                    {renderIf(
                                        passcodeStyle[0].activeColor == 'red'
                                    )(
                                        <Text
                                            style={[
