                ...
                >
                    <View style={styles.viewModelBody}>
                        ...
                        >
                            ...
                            >
                                Please keep this share safe, the sender might
                                need this share to restore wallet in case of
                                device loss
                            </Text>
                            <Avatar
                                medium
                            ...
                            >
                                ...
                                book. Tap on it to return share
                            </Text>
                        </View>
                        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                            ...
                            >
                                You will need to open the Hexa application on
                                your device once in two weeks to make sure the
                            ...
                            <FullLinearGradientButton
                                click_Done={() =>
                                    this.props.click_AcceptShare(walletName)
                                }
                                title="Accept Share"
                                disabled={false}
