    ...
    constructor(props: any) {
        ...
        this.state = {
            ...
            arr_QuestionList: [
                ...
                {
                    item:
                        'What was the first name of your favourite childhood friend?'
                },
                {
        ...
        try {
            ...
            if (resMnemonic.status == 200) {
                ...
                for (let i = 0; i < sssDetails.length; i++) {
                    let data = sssDetails[i];
                    if (data.decryptedShare != '') {
                        let decryptedShareJson = JSON.parse(
                            data.decryptedShare
                        );
                ...
                if (resCheckHealthAllShare != '') {
                    ...
                    if (resDecryptStaticNonPMDD.status == 200) {
                        ...
                        if (resImportSecureAccount.status == 200) {
                            resImportSecureAccount =
                                resImportSecureAccount.data;
                            ...
                            if (
                                ...
                                await bitcoinClassState.setS3ServiceClassState(
                                    sss
                                );
    ...
    renderError(id: any) {
        ...
        if (inputs[id].errorLabel) {
            return (
                <Text
                    style={[
                        validationService.styles.error,
                        { marginBottom: 5 }
                    ]}
                >
                        ...
                        <View style={styles.viewModelBody}>
                            ...
                            >
                                <Text style={{ textAlign: 'center' }}>
                                    ...
                                    as you did at the time of setting up the
                                    wallet
                                </Text>
                                ...
                                <Item
                                    rounded
                                    style={styles.itemInputWalletName}
                                >
                                    <Input
                                        secureTextEntry
                            ...
                            >
                                ...
                                >
                                    In case the answer does not match with the
                                    original answer, restoration process will
                                    fail
                                </Text>
