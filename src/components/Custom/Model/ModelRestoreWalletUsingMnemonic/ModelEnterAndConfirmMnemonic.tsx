                    ...
                    >
                        <View style={styles.viewModelBody}>
                            ...
                            >
                                ...
                                >
                                    Enter the mnemonic in the order that you
                                    noted at the time of setting up your wallet.
                                    In case of any typo the wallet restoration
                                    will fail
                                </Text>
                            </View>
                            <View
                            ...
                            >
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    {renderIf(
                                        this.state.style_TextAreaBorderColor ==
                                            'red'
                                    )(
                                        <Text
                                            note
