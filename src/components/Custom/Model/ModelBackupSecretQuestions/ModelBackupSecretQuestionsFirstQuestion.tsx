...
export default class ModelBackupSecretQuestionsFirstQuestion extends Component<
  Props,
  any
> {
        ...
        >
          ...
          >
            <View style={styles.viewModelBody}>
              ...
              >
                <Image
                  source={images.backupSecretQuestion.icon}
                  style={{
                    width: 80,
                    height: 80,
                    marginTop: -30,
                ...
                <Text note style={{ textAlign: 'center' }}>
                  Answer the question exactly as you did at the time of setting
                  up the wallet
                </Text>
                ...
                <Item rounded style={styles.itemInputWalletName}>
                  <Input
                    ...
                    onKeyPress={() => this.check_CorrectAnswer()}
                  />
                </Item>
              ...
              >
                ...
                >
                  Answer will be required in case you need to restore your
                  wallet
                </Text>
            ...
            <ModelPasscode
              data={this.state.arr_ModelPasscode}
              click_Next={() => {
                this.setState({
                  firstAnswer: '',
                  answerBorderColor: '#EFEFEF',
