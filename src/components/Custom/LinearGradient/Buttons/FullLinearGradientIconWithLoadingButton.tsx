...
export default class FullLinearGradientIconWithLoadingButton extends Component<Props, any> {
    render = ( { children } = this.props ) => {
        return (
            ...
            >
                ...
                <ActivityIndicator animating={ this.props.animating } size="small" color="#ffffff" style={ { marginRight: 5 } } />
                <Button
                    transparent
                    full
