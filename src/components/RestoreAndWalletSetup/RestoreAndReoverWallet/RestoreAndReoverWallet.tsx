    ...
    click_Card(item: any) {
        try {
            if (item == 'Set up as a New Wallet') {
                ...
                item == 'Continue restoring wallet using trusted source'
            ) {
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    Restoring a previously used wallet gives you
                                    back the access to your funds.
                                </Text>
                                <Text
                                    style={[
                                        styles.txtWhiteColor,
                                ...
                                >
                                    You can restore Hexa wallets using any of
                                    the methods and restore other wallet by
                                    using the mnemonic
                                </Text>
                            </View>
                        </KeyboardAwareScrollView>
