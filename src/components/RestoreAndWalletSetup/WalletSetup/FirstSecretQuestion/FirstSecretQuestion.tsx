            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.viewPagination}>
                        ...
                        >
                            Select the question and specify the answer at least
                            three characters long such that you always remember
                            it and no one can easily guess it
                        </Text>
                    </View>
                    ...
                    <View style={styles.viewProcedBtn}>
                        <Text
                            ...
                            numberOfLines={2}
                        >
                            The answer is never stored anywhere and even your
                            contacts don't know this answer{' '}
                        </Text>
