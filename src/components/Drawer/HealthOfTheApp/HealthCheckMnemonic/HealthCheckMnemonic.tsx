      ...
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.container}>
          ...
          >
            ...
            >
              <ModelHealthCheckMnemonicFirstWord
                data={arr_ModelHealthCheckMnemonicFirstWord}
                click_Next={() => {
                  this.setState({
                    arr_ModelHealthCheckMnemonicFirstWord: [
                      {
              ...
              />
              <ModelHealthCheckMnemonicSecoundWord
                data={arr_ModelHealthCheckMnemonicSecoundWord}
                click_Next={() => {
                  this.setState({
                    arr_ModelHealthCheckMnemonicSecoundWord: [
                      {
              ...
              />
              <ModelHealthCheckMnemonicThirdWord
                data={arr_ModelHealthCheckMnemonicThirdWord}
                click_Next={() => {
                  this.setState({
                    arr_ModelHealthCheckMnemonicThirdWord: [
                      {
              ...
              />
              <ModelHeackCheckMnemonicSucessBackedUp
                data={arr_ModelHeackCheckMnemonicSucessBackedUp}
                click_GoToWallet={() => {
                  this.setState({
                    arr_ModelHeackCheckMnemonicSucessBackedUp: [
                      {
