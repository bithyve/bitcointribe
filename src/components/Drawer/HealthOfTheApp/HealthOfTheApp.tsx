    ...
    constructor(props: any) {
        ...
        this.state = {
            ...
            arr_SelfShare: [
                {
                    thumbnailPath:
                        Platform.OS == 'ios' ? 'walletSVG' : 'walletPNG',
                ...
                {
                    thumbnailPath:
                        Platform.OS == 'ios' ? 'emailSVG' : 'emailPNG',
                    givenName: 'Email',
                    familyName: '',
                    statusMsgColor: '#ff0000',
                    statusMsg: 'Not Shared',
    ...
    loaddata = async (backupType: string, backupMethod: string) => {
        ...
        for (let i = 0; i < len; i++) {
            ...
            if (
                ...
                let data = await this.getTrustedContactArray(
                    sssDetails[i],
                    backupType
                );
            ...
            //Self Share
                ...
                data.backupType = backupType;
                data.flagAction =
                    sssDetails[i].decryptedShare != '' ? false : true;
        ...
        return (
            <Container>
                                                                    ...
                                                                    item.thumbnailPath !=
                                                                        ...
                                                                        <Avatar
                                                                            ...
                                                                            title={
                                                                                item.familyName !=
                                                                                null
                                                                                    ? item.givenName.charAt(
                                                                                          0
                                                                                      ) +
                                                                                      item.familyName.charAt(
                                                                                          0
                                                                                      )
                                                                                    : item.givenName.charAt(
                                                                                          0
                ...
                <ModelFindYourTrustedContacts
                    ...
                    click_Confirm={async () => {
                        await Permissions.request('contacts').then(
                            (response: any) => {
                                ...
                                if (response == 'authorized') {
                                    ...
                                    alert.simpleOk(
                                        'Oops',
                                        'Please add contacts permission.'
                                    );
                                }
                            }
                        );
