...
export default class Restore4And5SelfShareQRCodeScreen1 extends React.Component<Props, any> {
        ...
        try {
            ...
            if ( type == "iCloud" ) {
                if ( firstChar == "c01" ) {
                    ...
                    if ( flag_ReadQRCode ) {
                        alert.simpleOkAction( "Oops", "Please scan share 1 qrcode.", this.click_resetFlag );
                        flag_ReadQRCode = false;
                    }
                }
            } else {
