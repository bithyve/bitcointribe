...
export default class Restore4And5SelfShareQRCodeScreen2 extends React.Component<Props, any> {
        ...
        try {
            ...
            if ( type == "iCloud" ) {
                if ( firstChar == "c02" ) {
                    ...
                    if ( flag_ReadQRCode ) {
                        alert.simpleOkAction( "Oops", "Please scan share 2 qrcode.", this.click_resetFlag );
                        flag_ReadQRCode = false;
                    }
                }
            } else {
