                    ...
                    >
                        ...
                        >
                            <View style={{ flex: 0.2 }}>
                                ...
                                >
                                    Select the upto two contacts you trusted at
                                    the time of setting up your wallet
                                </Text>
                            </View>
                            <View style={{ flex: 1 }}>
                                <GridView
                                    ...
                                    itemDimension={
                                        Dimensions.get('screen').width / 4.0
                                    }
                                    itemsPerRow={3}
                                />
                                <FlatList
                        ...
                        {renderIf(this.state.flag_NextBtnDisable == false)(
                            <View style={styles.btnNext}>
                                <FullLinearGradientButton
                                    title="Next"
                                    disabled={
                                        this.state.flag_NextBtnDisable ||
                                        this.state.flag_NextBtnDisable1
                                    }
                                    style={[
