...
export default class SendPayment extends React.Component<any, any> {
    ...
    click_SendAmount = async () => {
        ...
        const { resTransferST, data } = await onSendAmountT1({ arr_SelectAccountDetails, address, amount, tranPrio, memo })
...
const mapStateToProps = state => {
    return {
        sendAmountDataT1: state.payementReducer.sendAmountDataT1
    };
};
