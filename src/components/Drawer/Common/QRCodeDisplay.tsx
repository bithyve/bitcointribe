          ...
          >
            <KeyboardAwareScrollView enableOnAndroid extraScrollHeight={40}>
              <View style={{ flex: 0.1, margin: 20 }}>
                ...
                >
                  Some information about the importance of trust with these
                  contacts
                </Text>
              </View>
              ...
              <View style={{ flex: 0.5, alignItems: 'center' }}>
                ...
                >
                  ...
                  Leo integer malesuada nunc vel. Purus faucibus ornare
                  suspendisse sed nisi lacus sed. Et ligula ullamcorper
                  malesuada proin libero nunc consequat. A cras semper auctor
                  neque vitae tempus quam pellentesque. In nisl nisi scelerisque
                  eu ultrices vitae auctor eu augue. Sed risus ultricies
                  tristique nulla aliquet enim tortor. Curabitur gravida arcu ac
                  tortor dignissim convallis. Adipiscing vitae proin sagittis
                  nisl rhoncus mattis rhoncus urna neque. Porta lorem mollis
