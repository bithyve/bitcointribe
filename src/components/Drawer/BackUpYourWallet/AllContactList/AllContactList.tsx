...
export default class AllContactList extends React.Component<any, any> {
  ...
  press = hey => {
    this.state.data.map((item, index) => {
      ...
      return this.state.SelectedFakeContactList.push(item);
    });
          ...
          <SafeAreaView style={styles.container}>
            <KeyboardAwareScrollView enableOnAndroid extraScrollHeight={40}>
              <View style={{ flex: 0.2 }}>
                ...
                >
                  Choose two contacts that you trust and who can help you
                  restore the wallet in case you lose the app
                </Text>
              </View>
              <View style={{ flex: 1 }}>
                <GridView
                  ...
                  renderItem={(item, index) => (
                    ...
                    >
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        >
                          <TouchableOpacity
                            onPress={() => this.click_RemoveGridItem(item)}
                          >
                            <SvgIcon
                              name="close-circle"
                              color="gray"
            ...
            {renderIf(this.state.flag_NextBtnDisable == false)(
              <View style={styles.btnNext}>
                <FullLinearGradientButton
                  title="Next"
                  disabled={this.state.flag_NextBtnDisable}
                  style={[
                    this.state.flag_NextBtnDisable == true
                      ? { opacity: 0.4 }
                      : { opacity: 1 },
                    {
                      borderRadius: 10,
