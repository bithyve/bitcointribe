                    ...
                    <SafeAreaView style={ [ styles.container, { backgroundColor: 'transparent' } ] }>
                        ...
                        >
                            <View style={ { flex: 0.1, margin: 20 } }>
                                <Text note style={ [ FontFamily.ffFiraSansMedium, { textAlign: "center" } ] }>Present this QR code to trusted contact to hold this secret for safekeeping </Text>
                            </View>
                            ...
                            <View style={ { flex: 0.5, alignItems: "center" } }>
                                <Text note style={ [ FontFamily.ffFiraSansMedium, { textAlign: "center", margin: 10 } ] }>Do not share this QR code with anyone other than the trusted contact whom you want to share the secret with </Text>
                            </View>
                        </KeyboardAwareScrollView>
                    </SafeAreaView>
                </ImageBackground>
