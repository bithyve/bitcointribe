...
export default class TrustedContact extends React.Component<any, any> {
    ...
    async componentWillMount() {
        ...
        if (otp != undefined) {
            ...
            if (
                (totalSec <
                    parseInt(expaire.trustedContactScreen.expaire_otptime) &&
    ...
    click_SentURLSmsOrEmail(type: string, value: any) {
        ...
        if (type == 'SMS') {
            SendSMS.send(
                {
                    body:
                        'https://prime-sign-230407.appspot.com/sss/bk/' +
                        encpScript,
                    recipients: [value],
                ...
                >
                    ...
                    >
                        <View style={{ flex: 0.1, margin: 20 }}>
                            ...
                            >
                                Health and history of the share will be shared
                                with{' '}
                            </Text>
                        </View>
                        <View
                        ...
                        {renderIf(this.state.flag_OtpCodeShowStatus != true)(
                            ...
                            >
                                ...
                                >
                                    Select method by which you want to share
                                    secret
                                </Text>
                                <FullLinearGradientShareButton
                                    click_Done={(title: string) => {
                        ...
                        <ModelTrustedContactEmailAndPhoneShare
                            data={
                                this.state.arr_TrustedContactEmailAndPhoneShare
                            }
