...
export default function LoaderModal(props) {
    return (<View style={{ height: hp('25%'),  backgroundColor: 'rgba(0, 0, 0, 0.3)'}}>
        <View style={styles.modalContentContainer}>
            ...
            <View style={{flex: 1, marginLeft:wp('8%'), marginRight:wp('8%'), marginTop:wp('8%')}}>
                ...
                <Text style={{marginRight: wp('20%'), color:Colors.textColorGrey, fontSize:RFValue(11), fontFamily:Fonts.FiraSansRegular, marginTop:props.isLoader ? wp('3%') : 'auto', marginBottom:props.isLoader ? 0 : wp('7%')}}>{props.messageText2 ? props.messageText2 : ''}</Text>
            </View>
