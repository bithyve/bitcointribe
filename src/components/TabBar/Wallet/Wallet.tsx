...
class Wallet extends React.Component {
                    ...
                    arrErrorMessage: [
                        {
                            ...
                            data: [
                                {
                                    message:
                                        'Fetching your regular account balance',
                                    bgColor: '#262A2E',
                                    color: '#ffffff'
                                }
                            ]
    ...
    click_SkipAssociateContact = async () => {
        try {
            ...
            if (deepLinkingUrlType == 'SSS Recovery QR') {
                ...
                let resDownlaodShare = await S3Service.downloadShare(
                ...
                if (resDownlaodShare.status == 200) {
                    ...
                    if (resGetWalletId.status == 200) {
                        await bitcoinClassState.setRegularClassState(
                            regularAccount
                        );
                    ...
                    for (let i = 0; i < resTrustedParty.length; i++) {
                        arr_DecrShare.push(
                            JSON.parse(resTrustedParty[i].decrShare)
                        );
                    }
                    ...
                    if (resDecryptEncMetaShare.status == 200) {
                        ...
                        const resUpdateHealth = await S3Service.updateHealth(
                            arr_DecrShare
                        );
    ...
    generateSSSDetails = async () => {
        try {
            ...
            let setUpWalletAnswerDetails = JSON.parse(
                ...
                if (
                    ...
                    if (resEncryptSocialStaticNonPMDD.status == 200) {
                        resEncryptSocialStaticNonPMDD =
                            resEncryptSocialStaticNonPMDD.data
                                .encryptedStaticNonPMDD;
                        ...
                        if (resEncryptBuddyStaticNonPMDD.status == 200) {
                            resEncryptBuddyStaticNonPMDD =
                                resEncryptBuddyStaticNonPMDD.data
                                    .encryptedStaticNonPMDD;
                            let rescreateMetaShare = await sss.createMetaShare(
                                1,
                                encryptedShares[0],
                                resEncryptSocialStaticNonPMDD,
                            ...
                            let resGenerateEncryptedMetaShare1 = await sss.generateEncryptedMetaShare(
                                rescreateMetaShare.data.metaShare
                            );
                            let rescreateMetaShare1 = await sss.createMetaShare(
                                2,
                                encryptedShares[1],
                                resEncryptSocialStaticNonPMDD,
                                walletDetails.walletType
                            ...
                            let resGenerateEncryptedMetaShare2 = await sss.generateEncryptedMetaShare(
                                rescreateMetaShare1.data.metaShare
                            );
                            let rescreateMetaShare2 = await sss.createMetaShare(
                                3,
                                encryptedShares[2],
                                resEncryptBuddyStaticNonPMDD,
                                walletDetails.walletType
                            );
                            let resGenerateEncryptedMetaShare3 = await sss.generateEncryptedMetaShare(
                                rescreateMetaShare2.data.metaShare
                            );
                            console.log({ rescreateMetaShare2 });
                            //for pdf
                            let rescreateMetaShare3 = await sss.createMetaShare(
                                4,
                                encryptedShares[3],
                                resEncryptBuddyStaticNonPMDD,
                                walletDetails.walletType
                            ...
                            if (rescreateMetaShare3.status == 200) {
                                ...
                                if (qrcode4share.status == 200) {
                                    ...
                                    temp.push({
                                        ...
                                        secondaryXpub: secondaryXpub,
                                        qrData:
                                            resSetupSecureAccount.setupData
                                                .qrData,
                                        secret:
                                            resSetupSecureAccount.setupData
                                                .secret,
                                    ...
                                    let resGenerate4thsharepdf = await this.generate4thShare(
                                        temp,
                                        setUpWalletAnswerDetails[0].Answer,
                                        walletDetails
                                    );
                                    ...
                                    if (resGenerate4thsharepdf != '') {
                                        let rescreateMetaShare4 = await sss.createMetaShare(
                                            5,
                                            encryptedShares[4],
                                            resEncryptBuddyStaticNonPMDD,
                                            walletDetails.walletType
                                        ...
                                        if (rescreateMetaShare4.status == 200) {
                                            var qrcode5share = await sss.createQR(
                                                rescreateMetaShare4.data
                                                    .metaShare,
                                                5
                                            );
                                            ...
                                            if (qrcode5share.status == 200) {
                                                qrcode5share =
                                                    qrcode5share.data.qrData;
                                                let temp = [];
                                                temp.push({
                                                    arrQRCodeData: qrcode5share,
                                                    secondaryXpub: secondaryXpub,
                                                    qrData:
                                                        resSetupSecureAccount
                                                            .setupData.qrData,
                                                    secret:
                                                        resSetupSecureAccount
                                                            .setupData.secret,
                                                ...
                                                console.log({ temp });
                                                let resGenerate5thsharepdf = await this.generate5thShare(
                                                    temp,
                                                    setUpWalletAnswerDetails[0]
                                                        .Answer,
                                                    walletDetails
                                                );
                                                console.log({
                ...
                this.setState(
                    ...
                    async () => {
                        ...
                        setTimeout(async () => {
                            ...
                            let res4thShare1Create = await this.generateSahreQRCode(
                                base64string1,
                                'qrcode4thSahre1.png'
                            );
                            // console.log( { res4thShare1Create } );
                            let res4thShare2Create = await this.generateSahreQRCode(
                                base64string2,
                                'qrcode4thSahre2.png'
                            );
                            //    console.log( { res4thShare2Create } );
                            let res4thShare3Create = await this.generateSahreQRCode(
                                base64string3,
                                'qrcode4thSahre3.png'
                            );
                            //  console.log( { res4thShare3Create } );
                            let res4thShare4Create = await this.generateSahreQRCode(
                                base64string4,
                                'qrcode4thSahre4.png'
                            );
                            //console.log( { res4thShare4Create } );
                            let res4thShare5Create = await this.generateSahreQRCode(
                                base64string5,
                                'qrcode4thSahre5.png'
                            );
                            //console.log( { res4thShare5Create } );
                            let res4thShare6Create = await this.generateSahreQRCode(
                                base64string6,
                                'qrcode4thSahre6.png'
                            );
                            //console.log( { res4thShare6Create } );
                            let res4thShare7Create = await this.generateSahreQRCode(
                                base64string7,
                                'qrcode4thSahre7.png'
                            );
                            //console.log( { res4thShare7Create } );
                            let res4thShare8Create = await this.generateSahreQRCode(
                                base64string8,
                                'qrcode4thSahre8.png'
                            );
                            //console.log( { res4thShare8Create } );
                            let resSecoundXpub4Share = await this.generateXpubAnd2FAQRCode(
                                base64string9,
                                'secoundryXpub4Share.png'
                            );
                            // console.log( { resSecoundXpub4Share } );
                            let res2FASecret4Share = await this.generateXpubAnd2FAQRCode(
                                base64string10,
                ...
                this.setState(
                    ...
                    async () => {
                        ...
                        setTimeout(async () => {
                            ...
                            let base64string9 = this.state.base64string9;
                            let base64string10 = this.state.base64string10;
                            let res5thShare1Create = await this.generateSahreQRCode(
                                base64string1,
                                'qrcode5thSahre1.png'
                            );
                            console.log({ res5thShare1Create });
                            let res5thShare2Create = await this.generateSahreQRCode(
                                base64string2,
                                'qrcode5thSahre2.png'
                            );
                            //    console.log( { res4thShare2Create } );
                            let res5thShare3Create = await this.generateSahreQRCode(
                                base64string3,
                                'qrcode5thSahre3.png'
                            );
                            //  console.log( { res4thShare3Create } );
                            let res5thShare4Create = await this.generateSahreQRCode(
                                base64string4,
                                'qrcode5thSahre4.png'
                            );
                            //console.log( { res4thShare4Create } );
                            let res5thShare5Create = await this.generateSahreQRCode(
                                base64string5,
                                'qrcode5thSahre5.png'
                            );
                            //console.log( { res4thShare5Create } );
                            let res5thShare6Create = await this.generateSahreQRCode(
                                base64string6,
                                'qrcode5thSahre6.png'
                            );
                            //console.log( { res5thShare6Create } );
                            let res5thShare7Create = await this.generateSahreQRCode(
                                base64string7,
                                'qrcode5thSahre7.png'
                            );
                            //console.log( { res5thShare7Create } );
                            let res5thShare8Create = await this.generateSahreQRCode(
                                base64string8,
                                'qrcode5thSahre8.png'
                            );
                            //console.log( { res5thShare8Create } );
                            let resSecoundXpub5Share = await this.generateXpubAnd2FAQRCode(
                                base64string9,
                                'secoundryXpub5Share.png'
                            );
                            // console.log( { resSecoundXpub4Share } );
                            let res2FASecret5Share = await this.generateXpubAnd2FAQRCode(
                                base64string10,
            ...
            return new Promise(async (resolve, reject) => {
                ...
                if (Platform.OS == 'android') {
                    docsDir =
                        ...
                        '/pdfFiles/'; // RNFS.DocumentDirectoryPath;
                } else {
                    docsDir = await PDFLib.getDocumentsDirectory();
                }
                docsDir =
                    Platform.OS === 'android' ? `file://${docsDir}` : docsDir;
                console.log({ docsDir });
    ...
    genreatePdf = async (
        ...
        try {
            return new Promise(async (resolve, reject) => {
                ...
                var firstArrSecondaryMnemonic,
                    secoundArrSecondaryMnemonic,
                    threeSecondaryMnemonic;
                ...
                threeSecondaryMnemonic = threeSecondaryMnemonic
                    .split(',')
                    .join(' ');
                //bhXpub
                // console.log( { bhXpub } );
                        ...
                        arrErrorMessage: [
                            {
                                ...
                                data: [
                                    {
                                        message:
                                            'Fetching your secure account balance',
                                        bgColor: '#262A2E',
                                        color: '#ffffff'
                                    }
                                ]
                        ...
                        arrErrorMessage: [
                            {
                                ...
                                data: [
                                    {
                                        message:
                                            'Checking health of your wallet',
                                        bgColor: '#262A2E',
                                        color: '#ffffff'
                                    }
                                ]
    ...
    render() {
        ...
        return (
            <Container>
                <SafeAreaView
                    style={{ flex: 0, backgroundColor: colors.appColor }}
                />
                <Content
                    scrollEnabled={false}
                                ...
                                arrErrorMessage: [
                                    {
                                        ...
                                        data: [
                                            {
                                                message:
                                                    'Fetching testcoins for your wallet',
                                                bgColor: '#262A2E',
                                                color: '#ffffff'
                                            }
                                        ]
