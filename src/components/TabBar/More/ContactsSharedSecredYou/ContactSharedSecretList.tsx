    ...
    click_SentRequest(type: string, val: any) {
        ...
        if (type == 'SMS') {
            ...
            SendSMS.send(
                {
                    body:
                        'https://prime-sign-230407.appspot.com/sss/res/' +
                        encpScript,
                    recipients: [val],
                                ...
                                >
                                    ...
                                    {renderIf(
                                        ...
                                        <Avatar
                                            ...
                                            rounded
                                            title={
                                                item.keeperInfo.givenName !=
                                                    null &&
                                                item.keeperInfo.givenName.charAt(
                                                    0
                                                )
                                            }
                                        />
                    ...
                    >
                        ...
                        >
                            <View style={{ flex: 0.2 }}>
                                ...
                                >
                                    Click on wallet name of trusted contact to
                                    send back share
                                </Text>
                            </View>
                        ...
                        >
                            <View>
                                ...
                                >
                                    {renderIf(
                                        arr_SelectedContact.thumbnailPath != ''
                                    )(
                                        <Avatar
                                            medium
                                            rounded
                                        ...
                                        <Avatar
                                            ...
                                            title={
                                                arr_SelectedContact.givenName !=
                                                    null &&
                                                arr_SelectedContact.givenName.charAt(
                                                    0
                                                )
                                            }
                                        />
