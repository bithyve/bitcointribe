    ...
    <View style={styles.modalContainer}>
      ...
      >
        <View style={styles.ElementView}>
          ...
          >
            Backup ensures that you can recover your wallet even if you lose your phone or accidently delete the Tribe Bitcoin App from your phone – set this up ASAP!
          </Text>
