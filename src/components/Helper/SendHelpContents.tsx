      ...
      >
        ...
        >
          ...
          >
            ...
            reason, it is recommended that you scan a QR{'\n'}code instead of
        ...
        >
          ...
          >
            ...
            bitcoin full node. This full node{'\n'}then announces the
            transactions to other full{'\n'}nodes, including those of miners
          </Text>
          <View style={{ justifyContent: 'center', alignItems: 'center' }}>
            <Image
          ...
          >
            ...
            fee associated is{'\n'}sufficiently high. This is why Hexa requests
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
            ...
            <TouchableOpacity
              style={{ marginLeft: 5 }}
              onPress={() => openLink('https://en.bitcoin.it/wiki/Miner_fees')}
            >
              <Text
                style={{
                  color: Colors.white,
