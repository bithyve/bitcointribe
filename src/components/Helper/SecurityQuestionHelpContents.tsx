    ...
    <View style={styles.modalContainer}>
      ...
      >
        ...
        >
          ...
          >
            Tribe Bitcoin will remind you of your Security Question routinely, helping you remember your question and answer. The Health Shield automatically updates when you answer correctly
          </Text>
          <Text
            style={{
              textAlign: 'center',
