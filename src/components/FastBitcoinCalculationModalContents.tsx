    ...
    return (<View style={styles.modalContainer}>
        <View style={styles.modalHeaderTitleView}>
            <View style={{ flexDirection: 'row', }}>
                ...
                <View>
                    ...
                    <Text style={styles.modalHeaderInfoText}>{props.pageInfo}{props.pageInfoNextLine ? "\n" + props.pageInfoNextLine : null}</Text>
                </View>
            </View>
        </View>
            ...
            <ScrollView style={{
                ...
                <View style={styles.textBoxView}>
                    <View style={styles.amountInputImage}>
                        <Fontisto name={"hashtag"} size={20} color={'#C6C6C6'} />
                    </View>
                    <TextInput
                        ...
                        onFocus={() => { props.modalRef.current.snapTo(2) }}
                        onBlur={() => { if (!BitcoinAddressRef.isFocused()) { props.modalRef.current.snapTo(1) } }}
                        value={VoucherCode}
                ...
                <TouchableOpacity activeOpacity={10} style={dropdownBoxOpenClose ? styles.dropdownBoxOpened : styles.dropdownBox} onPress={() => { setDropdownBoxOpenClose(!dropdownBoxOpenClose); }}>
                    <Text style={{ ...styles.dropdownBoxText, color: dropdownBoxValue.question ? Colors.textColorGrey : Colors.borderColor }}>{dropdownBoxValue.question ? dropdownBoxValue.question : 'Select bitcoin delivery'}</Text>
                ...
                <View style={{ position: 'relative', height: '100%' }}>
                    ...
                    <View style={{ ...styles.textBoxView, marginTop: hp('3%'), }}>
                        <View style={styles.amountInputImage}>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor={Colors.borderColor}
                            onFocus={() => { props.modalRef.current.snapTo(2) }}
                            onBlur={() => { if (!VoucherCodeRef.isFocused()) { props.modalRef.current.snapTo(1) } }}
        ...
        <View style={{ marginBottom: 20, marginTop: 'auto' }}>
            ...
            <TouchableOpacity style={{
                marginLeft: 20,
                marginRight: 20, backgroundColor: Colors.blue, width: wp('35%'), height: wp('13%'), justifyContent: 'center', alignItems: 'center', borderRadius: 10
            }}><Text style={{ color: Colors.white, fontSize: RFValue(13, 812), fontFamily: Fonts.FiraSansMedium }}>{props.proceedButtonText}</Text></TouchableOpacity>
        </View>
    </View>
    )
}
