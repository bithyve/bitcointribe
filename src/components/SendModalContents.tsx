  ...
  return ( <View style={styles.modalContentContainer}>
    <KeyboardAvoidingView style={{
      ...
      <ScrollView>
        ...
        <View style={{
          ...
          <View style={{
            ...
            <TextInput
              ...
              numberOfLines={4}
              style={{
                ...styles.textBox, paddingRight: 20, marginTop: 10, marginBottom: 10
              }}
        ...
        <View style={{
          height: 1, backgroundColor: Colors.borderColor, marginRight: 10, marginLeft: 10, marginTop: hp( '3%' ), marginBottom: hp( '3%' )
        }} />
        <View style={{
          paddingLeft: 20, paddingRight: 20
        }}>
          ...
          <Text style={{
            color: Colors.textColorGrey, fontSize: RFValue( 12 ), fontFamily: Fonts.Regular
          }}>Set priority for your transaction</Text>
          <View style={{
            ...styles.textBoxView, height: 55, marginTop: hp( '2%' ), alignItems: 'center', paddingLeft: 10, paddingRight: 10
          }}>
            <Slider
              style={{
              ...
              thumbStyle={{
                borderWidth:5, borderColor:Colors.white, backgroundColor:Colors.blue, height:30, width:30, borderRadius:15
              }}
              trackStyle={{
                height:8, borderRadius:10
              }}
              thumbTouchSize={{
                width: 30, height: 30, backgroundColor:'blue',
              }}
              value={sliderValue}
              onValueChange={( value ) => setSliderValue( value )}
            />
            <Text style={{
              color: Colors.textColorGrey, fontSize: RFValue( 13 ), fontFamily: Fonts.Regular, marginLeft: 'auto'
            }}>Low</Text>
          </View>
        </View>
        <View style={{
          paddingLeft: 20, paddingRight: 20, marginTop: hp( '5%' )
        }}>
          <Text style={{
            color: Colors.blue, fontSize: RFValue( 13 ), fontFamily: Fonts.Regular
          ...
          <Text style={{
            color: Colors.textColorGrey, fontSize: RFValue( 12 ), fontFamily: Fonts.Regular
          }}>Transaction fee will be calculated in the next step according to the amount of money being sent</Text>
        </View>
        <View style={{
          paddingLeft: 20, paddingRight: 20, flexDirection: 'row', marginTop: hp( '5%' ), marginBottom: hp( '3%' )
        }}>
          <TouchableOpacity
          ...
          <TouchableOpacity style={{
            ...styles.confirmButtonView, width: wp( '30%' ), backgroundColor: Colors.white
          }}>
            <Text style={{
