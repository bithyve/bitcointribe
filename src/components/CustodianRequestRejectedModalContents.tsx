    ...
    return (<View style={{ ...styles.modalContentContainer, height: '100%', }}>
        <View style={{ height: '100%' }}>
            <View style={{
                ...
                <Text style={styles.modalTitleText}>Secret Rejected{"\n"}Successfully</Text>
                <Text style={{ ...styles.modalInfoText, marginTop: wp('1.5%') }}>You have rejected the request to be a{"\n"}guardian for</Text>
            </View>
            ...
            <View>
                <View style={{
                    ...
                    <Text style={{ ...styles.modalInfoText }}>The sender will be notified that you have rejected the{"\n"}request to be a guardian</Text>
                </View>
            </View>
            <View style={{ flexDirection: 'row', marginTop: 'auto', alignItems: 'center' }} >
                ...
                <Image source={require('../assets/images/icons/reject.png')} style={styles.successModalImage} />
            </View>
        </View>
    </View>
    )
