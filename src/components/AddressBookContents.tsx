    ...
    return (<View style={styles.modalContainer}>
        ...
        <View>
            ...
            <View style={styles.selectedContactsView}>
                ...
                <TouchableOpacity  style={styles.shareButtonView}><Text style={styles.shareButtonText}>Share</Text></TouchableOpacity>
            </View>
                ...
                <View style={{ flex: 11 }}>
                    <ScrollView showsVerticalScrollIndicator={false} >
                        {contactData.map((value, index) => {
                            return <TouchableOpacity style={styles.contactView} >
