  ...
  return ( <KeyboardAvoidingView style={styles.modalContentContainer} behavior={Platform.OS == 'ios' ? 'padding' : ''} enabled>
    <View style={{
      ...
      <View style={{
        ...
        <View style={{
          paddingTop: wp( '8%' ), paddingLeft: wp( '7%' ), paddingRight: wp( '7%' ), paddingBottom: wp( '8%' ),
        }}>
          <Text style={{
            color: Colors.blue, fontSize: RFValue( 18 ), fontFamily: Fonts.Medium, marginTop: 10
          }}>Type in the name{'\n'}of your wallet</Text>
          <Text style={{
            ...styles.modalInfoText, marginTop: 7
          }}>Your contacts will see this to <Text style={{
              fontFamily: Fonts.MediumItalic, fontWeight: 'bold', fontStyle: 'italic'
            }}>identify you</Text></Text>
        </View>
        <TextInput
          style={{
            ...inputStyle, marginTop: wp( '2%' ), marginLeft: wp( '7%' ), marginRight: wp( '7%' ), marginBottom: wp( '10%' )
          }}
      ...
      <View style={{
        flexDirection: 'row', marginBottom: Platform.OS == 'ios' && DeviceInfo.hasNotch() ? hp( '2%' ) : 0
      }} >
        {walletName ?
          <TouchableOpacity
