  ...
  const shareOption = async () => {
    try {
      ...
      const options = Platform.select( {
        default: {
          title,
          message: `${walletName} wants to add you as ${props.isKeeper ? 'keeper' : 'Friends and Family'} on Tribe Bitcoin. Click on the link below and follow the steps in your Hexa app \n\n${shareLink}`,
        },
      } )
