			...
			<View style={{ flex: 1 }}>
				...
				<KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS == 'ios' ? 'padding' : ''} enabled>
					<View style={{ flex: 2 }}>
                        ...
                        infoTextNormal={"Use the Recover Secret stored in your secondary device. "}
					...
					<View style={{ flex: 4, alignItems: 'center', justifyContent: 'center' }}>
						<View>
							<Image
								style={{ width: hp('27%'), height: hp('27%') }}
					...
					<BottomInfoBox title={'Note'} infoText={'The transaction may not be instantly visible on the app as it may take some time to get confirmed on the blockchain'} />
					</View>
				</KeyboardAvoidingView>
			</View>
		</SafeAreaView>
