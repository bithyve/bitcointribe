...
public class MainApplication extends Application implements ReactApplication {
  ...
  private final ReactNativeHost mReactNativeHost = new ReactNativeHost(this) {
    ...
    protected List<ReactPackage> getPackages() {
      ...
      // new SvgPackage(), new SplashScreenReactPackage(), new RNSpinkitPackage(), new
      // RNSharePackage(),
      // new RandomBytesPackage(), new RNOSModule(), new LinearGradientPackage(), new
      // QRScanReaderPackage(),
      // new KeychainPackage(), new RNInAppBrowserPackage(), new ImagePickerPackage(),
      // new RNI18nPackage(),
      // new RNDeviceInfo(), new ReactNativeConfigPackage()
      );
    }
