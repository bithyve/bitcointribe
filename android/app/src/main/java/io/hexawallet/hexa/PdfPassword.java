...
public class PdfPassword extends ReactContextBaseJavaModule {
        ...
        public void createPdf(String pdfData, Callback errorCallback, Callback successCallback) {
                try {
                        ...
                        pdfWriter.setEncryption(jsonObj.getString("password").getBytes(),
                                        jsonObj.getString("password").getBytes(),
        ...
        private static void addTitlePage(Document document, String pdfData) throws DocumentException, JSONException {
                JSONObject jsonObj = new JSONObject(pdfData);
                ...
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(0), smallBold));
                document.add(preface);
                // part 2
                preface = new Paragraph();
                preface.add(new Paragraph("Part 2:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(1), smallBold));
                document.add(preface);

                document.newPage();
                // part 3
                preface = new Paragraph();
                preface.add(new Paragraph("Part 3:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(2), smallBold));
                document.add(preface);
                // part 4
                preface = new Paragraph();
                preface.add(new Paragraph("Part 4:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(3), smallBold));
                document.add(preface);
                document.newPage();

                // part 5
                preface = new Paragraph();
                preface.add(new Paragraph("Part 5:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(4), smallBold));
                document.add(preface);
                // part 6
                preface = new Paragraph();
                preface.add(new Paragraph("Part 6:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(5), smallBold));
                document.add(preface);
                document.newPage();

                // part 7
                preface = new Paragraph();
                preface.add(new Paragraph("Part 7:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(6), smallBold));
                document.add(preface);
                // part 8
                preface = new Paragraph();
                preface.add(new Paragraph("Part 8:", subFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(qrCodeString.getString(7), smallBold));
                document.add(preface);
                document.newPage();
                // Secondary Xpub and 2FA Secret
                preface = new Paragraph();
                preface.add(new Paragraph("Secondary Xpub (Encrypted):", catFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(jsonObj.getString("secondaryXpub"), smallBold));
                document.add(preface);

                preface = new Paragraph();
                preface.add(new Paragraph("Scan the above QR Code using your HEXA "
                                + "wallet in order to restore your Secure Account.", smallBold));
                document.add(preface);

                // Secondary Mnemonic and BitHyve Xpub
                preface = new Paragraph();
                preface.add(new Paragraph("Secondary Mnemonic:", catFont));
                document.add(preface);
                ...
                document.add(codeQrImage);
                preface = new Paragraph();
                preface.add(new Paragraph(jsonObj.getString("secondaryMnemonic"), smallBold));
                document.add(preface);

                preface = new Paragraph();
                preface.add(new Paragraph("BitHyve Xpub:", catFont));
                document.add(preface);
                preface = new Paragraph();
                preface.add(new Paragraph(jsonObj.getString("bhXpub"), smallBold));
                document.add(preface);
                preface = new Paragraph();
                preface.add(new Paragraph("Following assets can be used to recover your funds using "
                                + "the open - sourced ga - recovery tool.", smallBold));
                document.add(preface);
        ...
        public void print(String descFile, Callback errorCallback, Callback successCallback) {
                try {
                        ...
                        PdfReader reader = new PdfReader(jsonObj.getString("path"),
                                        jsonObj.getString("password").getBytes());
