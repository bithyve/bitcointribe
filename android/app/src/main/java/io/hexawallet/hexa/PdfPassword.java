...
//        document.add(preface);
        ...
        preface.add(new Paragraph(
                ...
                catFont));
        preface.add(new Paragraph(
                "Use this key to reset the 2FA if you have lost your authenticator app or for withdrawing your funds from Savings account if the BitHyve server is not responding",
                smallBold));
        document.add(preface);
